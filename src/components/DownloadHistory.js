...
import easyLogo from '../components/easypost-logo.svg';
import Easypost_b from '../components/easy_b.jpeg'
const DownloadHistory = ({ formData }) => {
  ...
  return (
    <div className="d-flex justify-content-start">
      {renderVendorLabel()}
      <button onClick={downloadLabel} className="theme-btn" style={{ padding: "2px 15px 2px 15px", borderRadius: "10px" }}>
        <FaDownload />
      </button>
    </div>
  );
