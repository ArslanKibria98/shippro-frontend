...
const LabelsHistoryForAdmin = () => {
   ...
   useEffect(() => {
      const fetchHistory = async () => {
         try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/api/admin/users/${id.id}/balance-history`, {
               headers: {
...
export default LabelsHistoryForAdmin;